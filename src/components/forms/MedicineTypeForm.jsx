...
const MedicineTypeForm = ({ onSubmit, initialData = null, isDarkMode, onCancel }) => {
  ...
  const handleSubmit = async () => {
    if (!name.trim()) {
      Toast.show({ type: 'error', text1: 'Error', text2: 'Medicine type name is required' });
      return;
    }
    ...
    try {
      ...
      console.error('Error submitting medicine type:', error);
    } finally {
      setSubmitting(false);
    }
  };
