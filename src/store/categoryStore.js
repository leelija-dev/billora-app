...
const useCategoryStore = create((set, get) => ({
  ...
  fetchCategories: async (page = 1, forceRefresh = false, append = false) => {
    console.log(
      "fetchCategories called with page:",
      page,
      "forceRefresh:",
      forceRefresh,
      "append:",
    ...
    try {
      ...
      console.log(
        `✅ Categories loaded successfully: ${finalCategories.length} categories`,
      );
      return response;
    } catch (error) {
  ...
  createCategory: async (categoryData) => {
    ...
    try {
      ...
      const payload = {
        ...
        is_active:
          categoryData.is_active === true || categoryData.is_active === 1
            ? 1
            : 0,
        created_by:
